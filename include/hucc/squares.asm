...
; ***************************************************************************
;
; squares.asm : 2KByte table of squares for fast multiplication.
;
; ***************************************************************************
; ***************************************************************************
;
; Copyright John Brandwood 2017-2025.
;
...
;
; square_plus_lo - 512 entry table of squares  fN = ((N*N)/4)
; square_plus_hi - 512 entry table of squares  fN = ((N*N)/4)
; square_minus_lo - 512 entry table of squares  fN = (((N-255)*(N-255))/4)
; square_minus_hi - 512 entry table of squares  fN = (((N-255)*(N-255))/4)
;
