...
/* P_EQU         */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_ORG         */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS,
/* P_PAGE        */	IN_CODE + IN_HOME + IN_DATA,
/* P_BANK        */	IN_CODE + IN_HOME + IN_DATA + IN_CONST,
/* P_INCBIN      */	IN_CODE + IN_HOME + IN_DATA + IN_CONST,
/* P_INCLUDE     */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
...
/* P_MACRO       */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_ENDM        */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_LIST        */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_MLIST       */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_NOLIST      */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_NOMLIST     */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_RSSET       */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_RS          */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_IF          */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
...
/* P_IFNDEF      */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
...
/* P_INESPRG     */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_INESCHR     */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_INESMAP     */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_INESMIR     */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_OPT         */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
...
/* P_ENDP        */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_PGROUP      */	IN_CODE + IN_HOME,
/* P_ENDPG       */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
...
/* P_ALIGN       */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_KICKC       */	ANYWHERE,
/* P_IGNORE      */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST + IN_XINIT,
/* P_SEGMENT     */	ANYWHERE,
/* P_LABEL       */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_ENCODING    */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_STRUCT      */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_ENDS        */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_3PASS       */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_ALIAS       */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
/* P_REF         */	IN_CODE + IN_HOME + IN_DATA + IN_ZP + IN_BSS + IN_CONST,
